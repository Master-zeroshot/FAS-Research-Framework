...
data = dict(batch_size=32, data_loader_workers=8, sampler=True, pin_memory=True)

resize = dict(height=224, width=224)

checkpoint = dict(
    snapshot_name="mobilenetv4_large_224_antispoof.pth.tar",
    experiment_path=get_log_path("logs_mobilenetv4_large"),
)
...
curves = dict(
    det_curve="det_curve_mobilenetv4_large.png",
    roc_curve="roc_curve_mobilenetv4_large.png",
)
...
test_file_name = "test_mobilenetv4_large"
